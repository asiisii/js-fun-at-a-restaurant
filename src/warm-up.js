...
inStock *= 2;
console.log(inStock)
// Reassign (not initialize) your "inStock" variable from above. You got hungry and needed
//a snack! Use a built in math operator to decrement the inStock count by 1.
--inStock;
console.log(inStock);
...
//console.log to see the value of shouldOrderMore
...
var vegetables = ["spinach","cauli","brocoli","pumkin","mushroom"];
...
// different fruits.
var fruits = ["apple","mango","pineapple","coconut","grape","pomogranate","banana"];
